...
The general rule: **never debug live**. If something fails twice, switch to the pre-recorded fallback (task 07). The audience would rather see a recording than a Mphasis person typing into a terminal.
