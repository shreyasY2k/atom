"""
financial-assistant — HTTP agent server (production)
...
app = FastAPI(title="financial-assistant", lifespan=lifespan)
...
_agent = ReActAgent(
    ...
    sys_prompt="You are a BFSI compliance assistant specialising in Indian regulatory frameworks.\nHelp teams understand RBI guidelines, SEBI regulations, DPDP Act, PCI-DSS, and KYC/AML.\nAlways cite the relevant regulation or circular. If unsure, say so clearly.",
    max_iters=5,
)
