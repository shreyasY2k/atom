"""
risk-checker — HTTP agent server (production)
...
app = FastAPI(title="risk-checker", lifespan=lifespan)
...
_agent = ReActAgent(
    ...
    sys_prompt="You are a financial risk assessment assistant.\nFor any transaction or scenario, always respond with:\n- Risk level (Low / Medium / High / Critical)\n- Risk category (Credit, Market, Operational, Liquidity, Compliance)\n- Rationale (2-3 sentences)\n- Recommended controls",
    max_iters=5,
)
