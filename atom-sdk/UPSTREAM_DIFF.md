...
> Document every change here when made in SESSION-06.
...
```bash
git remote add upstream https://github.com/modelscope/agentscope 2>/dev/null || true
git fetch upstream main
git checkout -b merge/atom-sdk-$(date +%Y%m%d)
git subtree merge --prefix=atom-sdk upstream/main --squash
